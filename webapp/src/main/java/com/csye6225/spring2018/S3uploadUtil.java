...
public class S3uploadUtil {
    ...
    final static String bucket_name="web-app.csye6225-spring2018-liruix.me";
    private static String _awsAccessKey = "AKIAIJKUJYXLPKXFFT7A";

    private static String _awsSecretKey = "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";
...
//         String bucketName = "web-app.csye6225-spring2018-yaojiaw.me";
...
//        String uploadFileName = path;
        ...
        try {
<<<<<<< HEAD
            expirationDate = new SimpleDateFormat("yyyy-MM-dd").parse("2018-03-21");
=======
            expirationDate = new SimpleDateFormat("yyyy-MM-dd").parse("2018-04-20");
>>>>>>> assignment09
        } catch (Exception e) {
            e.printStackTrace();
        }
